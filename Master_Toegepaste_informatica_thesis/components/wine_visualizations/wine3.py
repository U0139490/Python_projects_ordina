...
layout = html.Div(
    [
        ...
        html.P(["Task: Search for ", html.Span("Dolcetto d'Alba 2013",style={"fontWeight":"bold"})," and write down ", html.Span("the top 3",style={"fontWeight":"bold"})," most frequent wine characteristics looking at visualizations for:"]),
             html.Ul([
        ...
        html.Div(
                    ...
                    [
                        ...
                        html.Div(
                            [  html.Div(
                                    ...
                                    html.Label([ dcc.Dropdown(id="wine_input3",
                                ...
                                html.Div(
                                    [ html.H5('Average Rating'),html.H6(id="well_text"),  html.Div(id='output_averageRating_wine3',style={"fontSize":"20px","margin":"auto","margin-top":"15%","textAlign":"center"})],
                                    id="wells",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H5('Winery'),html.H6(id="gasText"),  html.Div(id='output_wineryName_wine3',style={"fontSize":"20px","margin":"auto","margin-top":"15%","textAlign":"center"})],
                                    id="gas",
                                    className="mini_container",
                                ),
                                html.Div(
                                    [html.H5('Country'), html.H6(id="oilText"), html.Div(id='output_countryName_wine3',style={"fontSize":"20px","margin":"auto","margin-top":"15%","textAlign":"center"})],
                                    id="oil",
                                    className="mini_container",
                                ),
          ...
          html.Div(
                [
                        html.Div(
                        [dcc.Graph(id="graph1_wine3")],
                        className="pretty_container",id="graph1_wine3_div"),

                        html.Div(
                        [dcc.Graph(id="graph2_wine3")],
                        className="pretty_container",id="graph2_wine3_div"),
            ...
            # html.Div([                
            #     html.H2('SECTION 3',style={"color":"white", "fontWeight":"bold","padding":"5px"}),
          html.Div(
            [
                html.Div(
                    [dcc.Graph(id="radarchart_negative")],
                    className="pretty_container five columns",id="div_radarchart"
                ),
                  html.Div(
                    [dcc.Graph(id="radarchart_neutral")],
                    className="pretty_container five columns",id="div_radarchart"
                ),
                  html.Div(
                    [dcc.Graph(id="radarchart_positive")],
                    className="pretty_container five columns",id="div_radarchart"
                ),
...
@app.callback(Output("graph1_wine3", "figure"),
             [Input("submit-button", "n_clicks")],
              [State("wine_input3", "value")])
...
@app.callback(Output("graph2_wine3", "figure"),
              [Input("submit-button", "n_clicks")],
              [State("wine_input3", "value")])
...
@app.callback([Output('output_averageRating_wine3', 'children'),
                Output('output_wineryName_wine3', 'children'),
                Output('output_countryName_wine3', 'children')],
             [Input("submit-button", "n_clicks")],
              [State("wine_input3", "value")])
...
@app.callback([Output("radarchart_negative", "figure"),
                Output("radarchart_neutral", "figure"),
                Output("radarchart_positive", "figure")],
              [Input("submit-button", "n_clicks")],
              [State("wine_input3", "value")])
def update_radarchart(n_clicks, input_value):
    if input_value is not None:
        specific_wine = (wine_csv_transform.loc[ wine_csv_transform['wine']== input_value])
        ...
        if len(negative_reviews) !=0:
            ...
            radarchart_negative = go.Scatterpolar(
                r=word_occurrence_negative.values,
                theta=word_occurrence_negative.index,
                fill='toself',
                marker_color="#DC3220",
        ...
        if len(positive_reviews) !=0:
            ...
            radarchart_positive = go.Scatterpolar(
                r=word_occurrence_positive.values,
                theta=word_occurrence_positive.index,
                fill='toself',
                marker_color="#005AB5",
        ...
        if len(neutral_reviews) !=0:
            ...
            radarchart_neutral = go.Scatterpolar(
                r=word_occurrence_neutral.values,
                theta=word_occurrence_neutral.index,
                fill='toself',
                marker_color="#FFC20A",
        ...
        layout_radarchart_negative = dict(
                        title = "Radarchart Negative Reviews ",
                        paper_bgcolor='rgba(0,0,0,0)',
                        plot_bgcolor='rgba(0,0,0,0)',
        ...
        layout_radarchart_positive = dict(
                        title = "Raderchart Positive Reviews ",
                        paper_bgcolor='rgba(0,0,0,0)',
                         plot_bgcolor='rgba(0,0,0,0)',
                         yaxis=dict(autorange="reversed"),
                        hovermode='closest',
        ...
        layout_radarchart_neutral = dict(
                        title = "Radarchart Neutral Reviews",
                        paper_bgcolor='rgba(0,0,0,0)',
                         plot_bgcolor='rgba(0,0,0,0)',
                         yaxis=dict(autorange="reversed"),
                        hovermode='closest',
        ...
        return  {
                "data": [radarchart_negative],
                "layout": layout_radarchart_negative,
            },{
                "data": [radarchart_neutral],
                "layout": layout_radarchart_neutral,
            },{
                "data": [radarchart_positive],
                "layout": layout_radarchart_positive,
            },
...
# @app.callback(
#     Output("wine_input3", "options"),
#     [Input("wine_input3", "search_value")],
# )
